...
ADJUSTMENTS: List[Adjustment] = [
    ...
    Adjustment(date="2025-07-12T09:19:49Z", label="motion-blend", exposure=1.0692, gamma=2.1519, saturation=1.2487, notes="Rebalanced weights after night runs."),
    Adjustment(date="2025-07-17T14:44:24Z", label="motion-blend", exposure=1.1952, gamma=1.8123, saturation=0.8258, notes="Mirrored adjustment from realtime demo results."),
    Adjustment(date="2025-08-07T09:19:18Z", label="shadow-bias", exposure=1.152, gamma=2.4375, saturation=1.2182, notes="Rebalanced weights after night runs."),
    Adjustment(date="2025-08-09T10:46:03Z", label="motion-blend", exposure=0.9545, gamma=1.9989, saturation=1.1387, notes="Smoothed spikes spotted in staging renders."),
    ...
    Adjustment(date="2025-09-22T17:42:00Z", label="motion-blend", exposure=1.0525, gamma=1.9377, saturation=1.0194, notes="Rebalanced weights after night runs."),
    Adjustment(date="2025-09-23T14:20:47Z", label="exposure-controller", exposure=0.9047, gamma=2.5406, saturation=0.8923, notes="Smoothed spikes spotted in staging renders."),
    Adjustment(date="2025-10-01T19:35:12Z", label="luminosity-check", exposure=0.9737, gamma=2.3246, saturation=1.0239, notes="Trimmed drift detected in rotating cube footage."),
    Adjustment(date="2025-10-24T16:05:54Z", label="temporal-dither", exposure=0.8647, gamma=2.5608, saturation=0.932, notes="Aligned defaults with export validation checklist."),
    Adjustment(date="2025-10-27T15:39:29Z", label="motion-blend", exposure=0.9519, gamma=2.2362, saturation=1.0667, notes="Trimmed drift detected in rotating cube footage."),
]

AVERAGE_EXPOSURE = 1.0867
AVERAGE_GAMMA = 2.1326
AVERAGE_SATURATION = 1.0413
